...
import com.example.test.administractor.Container;
import com.example.test.database.CommonDatabase;
import com.example.test.user.activity_user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (group.getCheckedRadioButtonId()) {
                    case R.id.radiobutton_user:
                        ...
                        textInputLayout_id.setHint("请输入您的ID");
        ...
        button_load.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (state == "guanliyuan") {
                ...
                } else if (state.equals("user")) { //用户登录
                    //去数据库中找账号为account的数据
                    String true_password = "123456";
                    ...
                    */
                    if (password_load.equals(true_password) && true_password.equals("") == false) {
                        isr();
                        Intent intent = new Intent(load.this, activity_user.class);
                        intent.putExtra("id", account_load);
